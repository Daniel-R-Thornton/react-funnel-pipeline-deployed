...
var FunnelChart = /*#__PURE__*/function (_React$Component) {
    ...
    if (data) {
      var _loop = function _loop() {
        ...
        if (thisRow.value >= 0) {
          ...
          }, React.createElement("div", null, showTitle ? React.createElement("div", {
            className: 'funnel-pipeline-chart-title',
            style: rowTitleStyle
          }, thisRow.name) : null, showValue ? React.createElement("div", {
  ...
  _proto.render = function render() {
    var _this$props2 = this.props,
      ...
      funnelShape = _this$props2.funnelShape,
      getTitleStyle = _this$props2.getTitleStyle;
    var titleStyle = {
      marginBottom: '30px'
    };
    ...
    var funnelShapeClassName = funnelShape === 'flat' ? 'funnel-pipeline-chart-flat' : 'funnel-pipeline-chart';
    var chartStyles = {};
    if (style) {
    ...
    return React.createElement("div", {
      className: funnelShapeClassName,
      style: chartStyles
